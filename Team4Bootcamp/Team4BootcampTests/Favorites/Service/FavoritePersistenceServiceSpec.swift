...
class FavoritePersistenceServiceSpec: QuickSpec {
    ...
    override func spec() {
        ...
        func initStubs() {
            let movie1 = Movie(id: 337167, title: "Fifty Shades Freed", releaseDate: Date(timeIntervalSince1970: 0), genresIds: [18, 10749], overview: "Believing they have left behind...", posterPath: "/jjPJ4s3DWZZvI4vw8Xfi4Vqa1Q8.jpg", persisted: false)
            
            let movie2 = Movie(id: 269149, title: "Zootopia", releaseDate: Date(timeIntervalSince1970: 0), genresIds: [16, 12, 10751, 35], overview: "Determined to prove herself...", posterPath: "/sM33SANp9z6rXW8Itn7NnG1GOEs.jpg", persisted: false)
